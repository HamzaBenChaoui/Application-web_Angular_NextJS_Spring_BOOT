...
const BarreNavigation = () => {
  ...
  const { isLoggedIn, logout, user } = useAuth(); // Get user from useAuth
      ...
      <nav className="bg-white border-b border-gray-100 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            {/* Côté droit Bureau - Authentification & Profil */}
            <div className="hidden md:flex items-center space-x-3">
              {isLoggedIn ? (
                      ...
                      <div className="py-2">
                        {[
                          ...
                          >
                            ...
                            <svg
                              className="w-4 h-4 text-[#bb00cc] opacity-0 group-hover:opacity-100 transform translate-x-2 group-hover:translate-x-0 transition-all duration-300 ml-auto"
                              fill="none"
                              stroke="currentColor"
                              viewBox="0 0 24 24"
                            >
                ...
                <Link
                  href="/login"
                  className="px-6 py-3 bg-gradient-to-r from-[#302652] to-[#bb00cc] text-white font-bold rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300"
                >
                  Connexion
                </Link>
              )}
          ...
          <div className="px-4 py-6 space-y-2">
            ...
            {isLoggedIn ? (
              ...
              <div className="pt-4 border-t border-gray-200">
                <Link
                  href="/login"
                  className="flex items-center justify-center space-x-4 w-full px-4 py-4 bg-gradient-to-r from-[#302652] to-[#bb00cc] text-white font-bold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300"
                  onClick={() => setMenuMobileOuvert(false)}
                >
                  <span className="text-xl">🔑</span>
