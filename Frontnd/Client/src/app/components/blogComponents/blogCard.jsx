...
const BlogCard = ({ post, basePath = 'blog' }) => {
  return (
    <Link href={`/${basePath}/${post.id}`}>
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden hover:shadow-lg hover:scale-[1.02] hover:border-gray-300 transition-all duration-300 cursor-pointer group h-full flex flex-col">
