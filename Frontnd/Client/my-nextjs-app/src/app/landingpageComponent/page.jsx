                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm md:text-base leading-relaxed">
                        Votre location sera assurée par AXA. Vous pouvez même
                        ajouter des conducteurs additionnels sans frais
                        supplémentaires.
                      </p>
                    </div>
                  </div>
                ...
                <div className="group">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm md:text-base leading-relaxed">
                        Réservez une voiture près de chez vous instantanément,
                        même à la dernière minute. Pas de file d'attente. Pas de
                        paperasse.
                      </p>
                    </div>
                  </div>
                ...
                <div className="group">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm md:text-base leading-relaxed">
                        Notre technologie sécurisée Getaround Connect vous
                        permet d'effectuer l'inspection de la voiture à l'aide
                        de l'application. La voiture s'ouvre. Les clés sont à
